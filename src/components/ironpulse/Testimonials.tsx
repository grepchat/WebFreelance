...
const testimonials = [
  { id: 1, name: 'Елена, 32 года', role: 'Похудела на 15 кг', text: 'За полгода я сбросила 15 кг без жёстких диет и голодовок. Главное — система. Александр дал мне понимание, как правильно питаться и тренироваться.', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=320' },
  { id: 2, name: 'Игорь, 27 лет', role: 'Набрал 10 кг мышц', text: 'Всегда был худой. Думал, что генетика. Оказалось, просто не было плана. Теперь жму 120 кг и выгляжу как атлет. Спасибо тренеру!', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=320' },
  { id: 3, name: 'Ольга, 38 лет', role: 'Вернула форму после родов', text: 'С двумя детьми казалось, что о спорте можно забыть. Но программа адаптирована под мой график. Результат превзошёл ожидания.', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=320' },
]
