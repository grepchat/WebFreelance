...
const results = [
  {
    ...
    time: '12 недель',
    change: '-14 кг',
    after: 'https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?q=80&w=1200',
  ...
  },
  {
    ...
    time: '8 недель',
    change: '-8 кг / Рельеф',
    after: 'https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=1200',
  ...
  },
  {
    ...
    time: '16 недель',
    change: '+9 кг массы',
    after: 'https://images.pexels.com/photos/29526365/pexels-photo-29526365.jpeg?auto=compress&cs=tinysrgb&w=1200',
          ...
          {results.map((item, index) => (
            ...
            >
              <div className="relative h-64">
                ...
                />
                <span className="absolute top-2 right-2 bg-iron-accent text-white text-xs px-2 py-1 uppercase font-bold">
                  После
                </span>
              </div>
              <div className="p-6">
